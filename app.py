...
CSS = """<style>
/* Self-hosted Inter (3 weights × 2 unicode-range subsets — covers Spanish + English).
   ~180 KB total, no third-party DNS/TLS, GDPR-clean. */
...
.hero-wrap::before{content:"";position:absolute;inset:0;background-image:url("https://whythelight.com/wp-content/uploads/2025/09/SN-Patch-placement-scaled-1-690x1024.jpg");background-size:cover;background-position:center 30%;background-repeat:no-repeat;filter:contrast(1.75);z-index:-2}
...
.hero-sub{position:relative;font-size:clamp(18px,2.2vw,28px);max-width:950px;margin:0 auto;line-height:1.55;color:var(--text);opacity:.92;z-index:1}
